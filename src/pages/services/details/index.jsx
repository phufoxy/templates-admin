...
@connect(({ user, loading, servicesDetails }) => ({ user, loading, data: servicesDetails.data }))
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['servicesDetails/GET_DATA'];
