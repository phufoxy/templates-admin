...
@connect(({ user, loading, typeRooms }) => ({
  user,
  loading,
  data: typeRooms.data,
  error: typeRooms.error,
  pagination: typeRooms.pagination,
}))
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['typeRooms/GET_DATA'];

    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý loại phòng" />
        <div className="d-flex justify-content-between align-items-center mb15">
          <h3 className={styles.heading}>Quản lý loại phòng</h3>
          <Button
