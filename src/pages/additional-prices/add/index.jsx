...
@connect(({ user, loading, additionalPricesAdd }) => ({
  user,
  loading,
  details: additionalPricesAdd.details,
  error: additionalPricesAdd.error,
}))
class Index extends PureComponent {
  ...
  componentDidMount() {
    ...
    if (params?.id) {
      dispatch({
        type: 'additionalPricesAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'additionalPricesAdd/UPDATE' : 'additionalPricesAdd/ADD',
      payload: {
        ...params,
        ...values,
  ...
  render() {
    ...
    const loadingSubmit =
      effects['additionalPricesAdd/ADD'] || effects['additionalPricesAdd/UPDATE'];
    const loading = effects['additionalPricesAdd/GET_DETAILS'];
    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý tùy chọn bổ sung" />
            ...
            >
              <Loading loading={loading} isError={error.isError} error={error}>
                ...
                <div className={styles['form-content']}>
                  <div className="row">
                    <div className="col-lg-12">
                      <Form.Item
                        ...
                        label={<span>Tên tùy chọn bổ sung</span>}
                      >
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <Form.Item name="price" label={<span>Tiền</span>}>
                        <InputNumber
