...
@connect(({ user, loading, additionalPrices }) => ({
  user,
  loading,
  data: additionalPrices.data,
  error: additionalPrices.error,
  pagination: additionalPrices.pagination,
}))
class Index extends PureComponent {
  ...
  onLoad = () => {
    ...
    this.props.dispatch({
      type: 'additionalPrices/GET_DATA',
      payload: {
        ...search,
        status,
      },
  ...
  header = () => {
    ...
    return [
      ...
      },
      {
        ...
        key: 'prices',
        className: 'min-width-180',
        render: (record) => Helper.getPrice(record.price),
      },
      {
        title: 'Trạng thái',
        key: 'status',
