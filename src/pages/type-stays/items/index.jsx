...
@connect(({ user, loading, typeStays }) => ({
  user,
  loading,
  data: typeStays.data,
  error: typeStays.error,
  pagination: typeStays.pagination,
}))
