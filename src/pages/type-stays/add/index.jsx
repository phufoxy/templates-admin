...
@connect(({ user, loading, typeStaysAdd }) => ({
  user,
  loading,
  details: typeStaysAdd.details,
  error: typeStaysAdd.error,
}))
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'typeStaysAdd/UPDATE' : 'typeStaysAdd/ADD',
      payload: {
        ...params,
        ...values,
  ...
  render() {
    ...
    const { files } = this.state;
    const loadingSubmit =
      effects['typeStaysAdd/ADD'] || effects['typeStaysAdd/UPDATE'] || effects['upload/UPLOAD'];
    const loading = effects['typeStaysAdd/GET_DETAILS'];
    const self = this;
    const props = {
      beforeUpload() {
        return null;
    ...
    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý loại lưu trú" />
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <Form.Item
                        ...
                        label={<span>Tên loại lưu trú</span>}
                      >
