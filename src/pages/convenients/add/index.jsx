...
@connect(({ user, loading, convenientsAdd }) => ({
  user,
  loading,
  details: convenientsAdd.details,
  error: convenientsAdd.error,
}))
class Index extends PureComponent {
  ...
  componentDidMount() {
    ...
    if (params?.id) {
      dispatch({
        type: 'convenientsAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'convenientsAdd/UPDATE' : 'convenientsAdd/ADD',
      payload: {
        ...params,
        ...values,
  ...
  render() {
    ...
    const loadingSubmit = effects['convenientsAdd/ADD'] || effects['convenientsAdd/UPDATE'];
    const loading = effects['convenientsAdd/GET_DETAILS'];
    return (
