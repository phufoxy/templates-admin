...
@connect(({ user, loading, nationsAdd }) => ({
  user,
  loading,
  details: nationsAdd.details,
  error: nationsAdd.error,
}))
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'nationsAdd/UPDATE' : 'nationsAdd/ADD',
      payload: {
        ...params,
        ...values,
  ...
  render() {
    ...
    const loadingSubmit = effects['nationsAdd/ADD'] || effects['nationsAdd/UPDATE'];
    const loading = effects['nationsAdd/GET_DETAILS'];
    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý quốc gia" />
