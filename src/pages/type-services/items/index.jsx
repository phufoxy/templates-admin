...
@connect(({ user, loading, typeServices }) => ({
  user,
  loading,
  data: typeServices.data,
  error: typeServices.error,
  pagination: typeServices.pagination,
}))
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['typeServices/GET_DATA'];

    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý loại gói dịch vụ" />
        <div className="d-flex justify-content-between align-items-center mb15">
          <h3 className={styles.heading}>Quản lý loại gói dịch vụ</h3>
          <Button
