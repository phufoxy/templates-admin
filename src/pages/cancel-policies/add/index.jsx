...
@connect(({ user, loading, cancelPoliciesAdd }) => ({
  user,
  loading,
  details: cancelPoliciesAdd.details,
  error: cancelPoliciesAdd.error,
}))
class Index extends PureComponent {
  ...
  componentDidMount() {
    ...
    if (params?.id) {
      dispatch({
        type: 'cancelPoliciesAdd/GET_DETAILS',
        payload: params,
      });
    }
  }
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'cancelPoliciesAdd/UPDATE' : 'cancelPoliciesAdd/ADD',
      payload: {
        ...params,
        ...values,
      },
  ...
  render() {
    ...
    const loadingSubmit = effects['cancelPoliciesAdd/ADD'] || effects['cancelPoliciesAdd/UPDATE'];
    const loading = effects['cancelPoliciesAdd/GET_DETAILS'];
    return (
