...
@connect(({ user, loading, bookingDetails }) => ({ user, loading, data: bookingDetails.data }))
class Index extends PureComponent {
  ...
  render() {
    ...
    const loading = effects['bookingDetails/GET_DATA'];
    ...
    return (
      <div className={styles['main-container']}>
        ...
        <div className="d-flex justify-content-between align-items-center mb10">
          <h3 className={styles['heading']}>Chi tiết booking</h3>
        </div>
        <div className="row">
