...
@connect(({ user, loading, utilities }) => ({
  user,
  loading,
  data: utilities.data,
  error: utilities.error,
  pagination: utilities.pagination,
}))
