...
@connect(({ user, loading, utilitiesAdd }) => ({
  user,
  loading,
  details: utilitiesAdd.details,
  error: utilitiesAdd.error,
}))
class Index extends PureComponent {
  ...
  onFinish = (values) => {
    ...
    this.props.dispatch({
      type: params.id ? 'utilitiesAdd/UPDATE' : 'utilitiesAdd/ADD',
      payload: {
        ...params,
        ...values,
  ...
  render() {
    ...
    const loadingSubmit = effects['utilitiesAdd/ADD'] || effects['utilitiesAdd/UPDATE'];
    const loading = effects['utilitiesAdd/GET_DETAILS'];
    return (
      <div className={styles['main-container']}>
        <Helmet title="Quản lý tiện ích" />
